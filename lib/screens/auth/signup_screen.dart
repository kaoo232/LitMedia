...
import 'package:flutter_backend_1/screens/pages/PhoneLogin.dart';
          ...
          children: [
                          ...
                          child: MyElevatedButton(
                            ...
                            onPressedFct: () async {
                              if (_formkey.currentState!.validate()) {
                                bool isUnique = await _auth.isUsernameUnique(
                                  name,
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              GestureDetector(
                                onTap: () async {
                                  final userG = await _auth.SignupWithGoogle();
                              ...
                              GestureDetector(
                                onTap: () async {
                                  ...
                                  if (userCredential != null) {
                                    print(
                                      "User logged in successfuly : ${userCredential.user?.email}",
                                    );
                                    Navigator.pushReplacement(
                                      context,
                                      MaterialPageRoute(
            ...
            Container(
              ...
              child: Align(
                ...
                child: Column(
                  children: [
                    Text("by creating an account or signing you agree to the"),
                    Textt(
